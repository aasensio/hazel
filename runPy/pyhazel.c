...
__PYX_EXTERN_C DL_IMPORT(void) c_hazel(int *, int *, double *, double *, double *, double *, double *, double *, int *, int *, int *, double *, int *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, double *, int *, double *, double *, double *, double *); /*proto*/
...
static const char __pyx_k_pyhazel[] = "pyhazel";
...
static const char __pyx_k_scratch_Dropbox_GIT_hazel_runPy[] = "/scratch/Dropbox/GIT/hazel/runPy/pyhazel.pyx";
...
static PyObject *__pyx_kp_s_scratch_Dropbox_GIT_hazel_runPy;
...
static PyObject *__pyx_pf_7pyhazel_synth(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_synModeInput, int __pyx_v_nSlabsInput, PyArrayObject *__pyx_v_B1Input, PyArrayObject *__pyx_v_B2Input, double __pyx_v_hInput, double __pyx_v_tau1Input, double __pyx_v_tau2Input, PyArrayObject *__pyx_v_boundaryInput, int __pyx_v_transInput, int __pyx_v_atomicPolInput, int __pyx_v_magoptInput, PyArrayObject *__pyx_v_anglesInput, int __pyx_v_nLambdaInput, PyArrayObject *__pyx_v_lambdaAxisInput, double __pyx_v_dopplerWidthInput, double __pyx_v_dopplerWidth2Input, double __pyx_v_dampingInput, double __pyx_v_dopplerVelocityInput, double __pyx_v_dopplerVelocity2Input, double __pyx_v_ffInput, double __pyx_v_betaInput, double __pyx_v_beta2Input, PyArrayObject *__pyx_v_nbarInput, PyArrayObject *__pyx_v_omegaInput, int __pyx_v_normalization); /* proto */
...
static PyObject *__pyx_pw_7pyhazel_1synth(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("synth (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nSlabsInput)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_B1Input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_B2Input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 3); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_hInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 4); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tau1Input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 5); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_tau2Input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 6); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_boundaryInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 7); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_transInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 8); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  9:
        if (likely((values[9] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_atomicPolInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 9); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 10:
        if (likely((values[10] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_magoptInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 10); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 11:
        if (likely((values[11] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_anglesInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 11); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 12:
        if (likely((values[12] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nLambdaInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 12); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 13:
        if (likely((values[13] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_lambdaAxisInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 13); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 14:
        if (likely((values[14] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dopplerWidthInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 14); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 15:
        if (likely((values[15] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dopplerWidth2Input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 15); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 16:
        if (likely((values[16] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dampingInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 16); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 17:
        if (likely((values[17] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dopplerVelocityInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 17); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 18:
        if (likely((values[18] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_dopplerVelocity2Input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 18); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 19:
        if (likely((values[19] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_ffInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 19); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 20:
        if (likely((values[20] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_betaInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 20); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 21:
        if (likely((values[21] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_beta2Input)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 21); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 22:
        if (likely((values[22] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nbarInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 22); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 23:
        if (likely((values[23] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_omegaInput)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 23); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case 24:
        if (likely((values[24] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_normalization)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, 24); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "synth") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_normalization = __Pyx_PyInt_As_int(values[24]); if (unlikely((__pyx_v_normalization == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("synth", 1, 25, 25, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_omegaInput), __pyx_ptype_5numpy_ndarray, 1, "omegaInput", 0))) __PYX_ERR(0, 18, __pyx_L1_error)
...
static PyObject *__pyx_pf_7pyhazel_synth(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_synModeInput, int __pyx_v_nSlabsInput, PyArrayObject *__pyx_v_B1Input, PyArrayObject *__pyx_v_B2Input, double __pyx_v_hInput, double __pyx_v_tau1Input, double __pyx_v_tau2Input, PyArrayObject *__pyx_v_boundaryInput, int __pyx_v_transInput, int __pyx_v_atomicPolInput, int __pyx_v_magoptInput, PyArrayObject *__pyx_v_anglesInput, int __pyx_v_nLambdaInput, PyArrayObject *__pyx_v_lambdaAxisInput, double __pyx_v_dopplerWidthInput, double __pyx_v_dopplerWidth2Input, double __pyx_v_dampingInput, double __pyx_v_dopplerVelocityInput, double __pyx_v_dopplerVelocity2Input, double __pyx_v_ffInput, double __pyx_v_betaInput, double __pyx_v_beta2Input, PyArrayObject *__pyx_v_nbarInput, PyArrayObject *__pyx_v_omegaInput, int __pyx_v_normalization) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_boundaryInput.rcbuffer->pybuffer, (PyObject*)__pyx_v_boundaryInput, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 13, __pyx_L1_error)
  }
 ...
 */
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_empty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_nLambdaInput); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 58, __pyx_L1_error)
 ...
 */
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_empty); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_nLambdaInput); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_nLambdaInput); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_scratch_Dropbox_GIT_hazel_runPy, __pyx_k_scratch_Dropbox_GIT_hazel_runPy, sizeof(__pyx_k_scratch_Dropbox_GIT_hazel_runPy), 0, 0, 1, 0},
 ...
 * 	ar[double,ndim=2] boundaryInput, int transInput, int atomicPolInput, int magoptInput, ar[double,ndim=1] anglesInput,
 */
  __pyx_tuple__10 = PyTuple_Pack(29, __pyx_n_s_synModeInput, __pyx_n_s_nSlabsInput, __pyx_n_s_B1Input, __pyx_n_s_B2Input, __pyx_n_s_hInput, __pyx_n_s_tau1Input, __pyx_n_s_tau2Input, __pyx_n_s_boundaryInput, __pyx_n_s_transInput, __pyx_n_s_atomicPolInput, __pyx_n_s_magoptInput, __pyx_n_s_anglesInput, __pyx_n_s_nLambdaInput, __pyx_n_s_lambdaAxisInput, __pyx_n_s_dopplerWidthInput, __pyx_n_s_dopplerWidth2Input, __pyx_n_s_dampingInput, __pyx_n_s_dopplerVelocityInput, __pyx_n_s_dopplerVelocity2Input, __pyx_n_s_ffInput, __pyx_n_s_betaInput, __pyx_n_s_beta2Input, __pyx_n_s_nbarInput, __pyx_n_s_omegaInput, __pyx_n_s_normalization, __pyx_n_s_wavelengthOutput, __pyx_n_s_stokesOutput, __pyx_n_s_epsOutput, __pyx_n_s_etaOutput); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(25, 0, 29, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_scratch_Dropbox_GIT_hazel_runPy, __pyx_n_s_synth, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 13, __pyx_L1_error)
 ...
 * 	Initialize and do some precomputations that can be avoided in the subsequent calls to the synthesis
 */
  __pyx_codeobj__12 = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_scratch_Dropbox_GIT_hazel_runPy, __pyx_n_s_init, 71, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__12)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pyhazel")) {
      if (unlikely(PyDict_SetItemString(modules, "pyhazel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * 	ar[double,ndim=2] boundaryInput, int transInput, int atomicPolInput, int magoptInput, ar[double,ndim=1] anglesInput,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7pyhazel_1synth, NULL, __pyx_n_s_pyhazel); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
 ...
 * 	Initialize and do some precomputations that can be avoided in the subsequent calls to the synthesis
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_7pyhazel_3init, NULL, __pyx_n_s_pyhazel); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
