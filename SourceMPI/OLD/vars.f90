...
!	integer :: nemiss, no
	...
	type variable_parameters
		real(kind=8) :: bgauss, thetabd, chibd, vdopp, dtau, delta_collision, vmacro, damping, beta, height
		real(kind=8) :: dtau2, vmacro2
	...
	type type_observation
		integer :: n, npixel, ny, pix_id, col_id, nlambda_id, lambda_id, map_id, obs_id
		integer :: observation_format, boundary_id, height_id, obsangle_id
	...
	character(len=6) :: parameters_name(12) = (/ 'B     ','thetaB','chiB  ', 'vdopp ', &
